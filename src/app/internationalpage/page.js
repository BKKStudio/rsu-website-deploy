          ...
          <div className={styles.iteminfrom2}>
            <div className={styles.creteform}>
              ...
              <option value="">-- Select Faculty --</option>
                <option value="วิทยาลัยวิศวกรรมศาสตร์(College of Engineering)">College of Engineering</option>
                <option value="คณะดิจิทัลอาร์ต (Faculty of Digital Art)">Faculty of Digital Art</option>
                <option value="คณะทัศนมาตรศาสตร์(Faculty of Optometry)">Faculty of Optometr</option>
                <option value="คณะเทคนิคการแพทย์(Faculty of Medical Technology)">Faculty of Medical Technology</option>
              </select>
            </div>
            <div className={styles.creteform}>
              <label>Major</label>
