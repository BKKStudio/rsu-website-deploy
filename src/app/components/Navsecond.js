import styles from "../styles/Navse.module.css";
import Link from "next/link";

export default function Navbarsecond() {
  return (
    <nav className={styles.containernav}>
      <div className={styles.innavcon}>
        <div>
          <Link href={"/indexpage"}>หน้าแรก</Link>
          <Link href={"https://intranet.rsu.ac.th/suWeb/SignIn.aspx"}>อินทราเน็ต</Link>
          <Link href={"/"}>นักศึกษา</Link>
